...
\title{{\small package}\\[0.5cm] \huge causets \\[0.2cm]{\small version 1.3.1\\[0.5cm]}}
...
\tikzcausetsset{large, events={black!20}, links={black!10}, label color={black!30}}
\subsection{v1.3.1, 2022-07-27}
\begin{itemize}\itemsep=-1ex
  \item Bug fix: Automatic event labels are now correctly printed when using \lstinline§offset=§\PH.
\end{itemize}
...
\begin{itemize}\itemsep=-1ex
  \item \versioncauset{v1-2}{\pcauset[cap links]{1,3,2}}%
