...
This relation forms a light-cone structure such that all past and future related elements fall within a lower and upper cone, respectively, opening in 90 degree angles.

This package is based on TikZ.
The drawing algorithm makes use of the fact that every finite causet that embeds in $\smash{1 + 1}$ dimensional Minkowski spacetime can be represented by a product of two total orders (2-order), where one order is assumed to be the standard total order of the integers labelling all causet elements, while the other is a permutation of the labels\footnote{See \url{https://arxiv.org/abs/0706.0375} and \url{https://arxiv.org/abs/2011.02965} for more details on 2-orders and causal sets.}.
...
A support for \LaTeX\textsc{ML} is currently under construction.
...
\begin{center}
  \includegraphics[scale=0.9]{causets_example2}
\end{center}
...
\subsection[v1.5 (Diamond-Diamond)]{v1.5 (in development)}

\subsubsection{New features}

\begin{itemize}\itemsep=-1ex
\item \versioncauset{v1-5}{\pcauset{1,5,3,6/{violet, label=XML, labels={violet, above=1ex, at=north}},2,4}}%
  Adding support for \LaTeX\textsc{ML}.
\end{itemize}
