...
\begin{document}
\begin{tikzpicture}
	% Create causet, shifted in x- and y-direction to test note positions:
	...
	\draw[ultra thick, blue, ->] (FinfLabel.west) -- (Finf);
	\draw[ultra thick, red, ->] (centerLabel.east) -- (3, -1);  % center was shifted by the scope
	\draw[ultra thick, green!50!black, ->] (myEventLabel.west) -- (E0);
\end{tikzpicture}
\end{document}
