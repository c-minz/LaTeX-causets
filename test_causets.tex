...
\item \verb$\pcauset$ test \pcauset[permutation, spatial links={densely dotted}, alt={N with permutation}, black colors]{2,4,1,3} in black/white with permutation grid, spatial links (densely dotted), and attribute \verb$alt={N with permutation grid}$.
